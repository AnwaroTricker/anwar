...
def tik():
	...
	for o in titik:
		...
		print("\r\x1b[1;93mAnwarTrickerâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
💙💙💙💙💙💙💙💙💙💙💙💙💙
 ...
 \033[1;96m   ANWAR       WHATSAPP Number +923498940903
...
def Zeek():
    ...
    print '\x1b[1;91m[1] ANWAR Start Cracking'
...
def action():
    ...
    if peak =='':
        ...
        print ' Enter any code \x1b[1;92mJazz 01.02.03.04.05.06.07.08.09
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    print '\033[1;91m(ANWARCP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            print '\033[1;93m(ANWARCP) ' + k + c + user + '  |  ' + pass2
    ...
    print 'ANWAR Khan Process Has Been Completedâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’...100%'

    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))

    print('AnWAr Cloned Accounts Has Been Saved : save/cloned.txt')

    jalan("Note : Your ANWARKING(CP)Accounts Open after 5 to 8 days")
...
\033[1;91mThanks \033[1;97mUseing ANWAR TRICKER Tool
...
try:
    ...
    os.system('Then type: python2 anwarking.py')
...
💙💙💙💙💙💙💙💙💙💙💙💙💙
 ...
 \033[1;96m          WHATSAPP NO +16088568560
...
def Zeek():
    ...
    print '\x1b[1;91m[1] AR KHAN Start Cracking'
...
def action():
    ...
    print 'AnwarTricker Process Has Been Completedâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’...100%'

    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))

    print('AnwarTricker Cloned Accounts Has Been Saved : save/cloned.txt')
...
\033[1;91mThanks \033[1;97mUseing My ANWAR TRICKER Tool
